...
def test_plot_metric_until_diagnosis(
    subsampled_eval_dataset: EvalDataset,
    test_plot_path: Path,
):
    plot_sensitivity_by_time_until_diagnosis(
...
def test_plot_auc_time_from_first_visit(
    subsampled_eval_dataset: EvalDataset,
):
    plot_roc_auc_by_time_from_first_visit(
        eval_dataset=subsampled_eval_dataset,
...
def test_plot_time_from_first_positive_to_event(
    subsampled_eval_dataset: EvalDataset,
    test_plot_path: Path,
):
    plot_time_from_first_positive_to_event(
...
def test_get_sens_by_time_to_outcome_df(
