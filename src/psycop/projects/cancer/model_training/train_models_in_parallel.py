...
def main(
    ...
    spawn_trainers(
        ...
        train_single_model_file_path=Path(
            "src/psycop/projects/cancer/model_training/train_model_from_application_module.py",
        ),
    )
...
def train_models_in_parallel(dataset_override_path: Optional[Path] = None):
    ...
    cfg, wandb_group = setup(
        config_file_name=CONFIG_FILE_NAME,
        application_config_dir_relative_path="../../../../psycop/projects/cancer/model_training/config/",
    )
