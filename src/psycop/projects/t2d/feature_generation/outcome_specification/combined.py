...
from psycop.projects.t2d.feature_generation.outcome_specification.medications import (
    get_first_antidiabetic_medication,
)
from psycop.projects.t2d.feature_generation.outcome_specification.t1d_diagnoses import (
    get_first_type_1_diabetes_diagnosis,
)
from psycop.projects.t2d.feature_generation.outcome_specification.t2d_diagnoses import (
