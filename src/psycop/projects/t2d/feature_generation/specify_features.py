...
from psycop.projects.t2d.feature_generation.outcome_specification.combined import (  # noqa: RUF100
    get_first_diabetes_indicator,
)
from psycop.projects.t2d.feature_generation.outcome_specification.lab_results import (  # noqa: RUF100
