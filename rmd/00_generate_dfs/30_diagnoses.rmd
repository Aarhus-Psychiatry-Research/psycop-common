...
write_csv(df_all_visits_combined, here("csv", "all_visits_combined.csv"))
```
...
```{r}
write_csv(df_first_t2d_diagnoses_combined, here("csv", "first_t2d_diagnosis.csv"))
```

```{r}
df_first_t2d_diagnoses_combined <- read_csv(here("csv", "first_t2d_diagnosis.csv"))
```
```
...
```{r}
write_csv(df_first_t1d_diagnoses_combined, here("csv", "first_t1d_diagnosis.csv"))
```

```{r}
df_first_t1d_diagnoses_combined <- read_csv(here("csv", "first_t1d_diagnosis.csv"))
```
