...
from psycop_model_training.model_eval.artifacts.plots import plot_basic_chart
...
from psycop_model_training.model_eval.artifacts.plots import plot_prob_over_time
