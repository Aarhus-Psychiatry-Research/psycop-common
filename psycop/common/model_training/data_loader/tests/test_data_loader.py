...
def test_load_dataset_from_dir(tmpdir, base_feature_df: pd.DataFrame, feature_df_different_split: pd.DataFrame):
    ...
    data_cfg = DataSchema(
        ...
        col_name=ColumnNamesSchema(outcome_timestamp=None,
                                    age=None,
                                    is_female=None),
    )
