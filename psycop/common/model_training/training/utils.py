...
def create_eval_dataset(
    col_names: ColumnNamesSchema, outcome_col_name: Union[str, list[str]], df: pd.DataFrame
) -> EvalDataset:
    ...
    eval_columns = {
        col_name: df[col_name] for col_name in df.columns if col_name.startswith("eval_")
    }
    ...
    eval_dataset = EvalDataset(
        ...
        outcome_timestamps=df[col_names.outcome_timestamp] if col_names.outcome_timestamp else None,
