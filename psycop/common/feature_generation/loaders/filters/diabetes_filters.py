...
def keep_rows_where_diag_matches_t2d_diag(df: pd.DataFrame, col_name: str) -> pd.DataFrame:
    """
...
def keep_rows_where_diag_matches_t1d_diag(df: pd.DataFrame, col_name: str) -> pd.DataFrame:
    """
