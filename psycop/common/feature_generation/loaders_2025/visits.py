...
def physical_visits_2025(
    ...
    source_schemas = {
        "LPR3": RawValueSourceSchema(
            view="[CVD_T2D_LPR3kontakter_marts_2025]",
...
def physical_visits_to_somatic_2025(
    n_rows: Union[int, None] = None, return_value_as_visit_length_days: Union[bool, None] = False
) -> pd.DataFrame:
