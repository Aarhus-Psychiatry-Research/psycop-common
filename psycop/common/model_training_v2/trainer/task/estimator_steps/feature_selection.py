...
def select_percentile(
    score_function_name: IMPLEMENTED_FUNCTIONS, percentile: int
) -> ModelStep:
...
class FeatureSelectionSuggester(Suggester):
    ...
    def suggest_hyperparameters(self, trial: optuna.Trial) -> dict[str, str]:
        ...
        return {"@estimator_steps": "select_percentile", "score_function_name": score_function, "percentile": percentile}