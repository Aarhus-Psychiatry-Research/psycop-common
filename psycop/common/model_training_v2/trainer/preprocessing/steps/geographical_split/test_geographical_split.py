...
def test_get_first_visit_at_each_region_by_patient(mock_geography_data: pl.DataFrame):
    ...
    assert_frame_equal(
        first_visit_at_each_region_df, expected.select("dw_ek_borger", "region", "timestamp")
    )
...
def test_get_first_visit_at_second_region_by_patient(mock_geography_data: pl.DataFrame):
    ...
    assert_frame_equal(
        ...
        expected.select("dw_ek_borger", "second_region", "first_regional_move_timestamp"),
    )
...
def test_add_migration_date_for_each_patient():
    ...
    ).with_columns(pl.col("first_regional_move_timestamp").cast(pl.Datetime(time_unit="us")))
