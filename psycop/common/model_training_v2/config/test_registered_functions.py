...
def test_registered_functions():
    ...
    if generated_new_configs and ON_CI_RUNNER:
        raise Exception(f"New configs were generated, indicating this PR breaks backwards compatibility. Re-run the test locally, commit the new configs to the repository, and then ensure backwards compatability to continue.")
