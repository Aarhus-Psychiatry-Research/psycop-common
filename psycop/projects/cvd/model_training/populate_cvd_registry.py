...
def populate_with_cvd_registry() -> None:
    ...
    from psycop.projects.cvd.model_training.preprocessing.regex_filter import RegexColumnBlacklist
    from psycop.projects.cvd.model_training.preprocessing.datetime_filter import TemporalColumnFilter
