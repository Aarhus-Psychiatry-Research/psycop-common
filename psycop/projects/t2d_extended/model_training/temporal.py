...
def eval_temporal_stability(
    ...
    cfg = (
        ...
        .mut(
            ...
            f"E:/shared_resources/t2d_extended/training/T2D-extended, temporal validation/{training_start_date}_{training_end_date}_{evaluation_interval[0]}_{evaluation_interval[1]}",
        )
        .add(
