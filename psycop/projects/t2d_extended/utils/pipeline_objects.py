...
@dataclass
class T2DExtendedArtifactNames:
    main_performance_figure: str = "t2d_extended_main_performance_figure.png"
    main_robustness_figure: str = "t2d_extended_main_robustness.png"
    performance_by_ppr: str = "t2d_extended_performance_by_ppr.xlsx"
