...
def t2d_extended_output_performance_by_ppr(run: T2DExtendedPipelineRun) -> pd.DataFrame:
    output_path = (
...
if __name__ == "__main__":
    ...
    table = t2d_extended_output_performance_by_ppr(run=get_best_eval_pipeline())
