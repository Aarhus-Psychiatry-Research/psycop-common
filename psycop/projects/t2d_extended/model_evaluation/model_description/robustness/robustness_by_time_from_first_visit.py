...
def t2d_extended_auroc_by_time_from_first_visit(run: T2DExtendedPipelineRun) -> pn.ggplot:
...
if __name__ == "__main__":
    t2d_extended_auroc_by_time_from_first_visit(run=get_best_eval_pipeline())
