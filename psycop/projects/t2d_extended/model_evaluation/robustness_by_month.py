"""Evaluate model performance by month of the year.
...
def plotnine_auroc_by_month(df: pd.DataFrame, title: str = "") -> pn.ggplot:
    ...
    df["time_bin"] = pd.Categorical(df["time_bin"], categories=month_order, ordered=True)
...
if __name__ == "__main__":
    ...
    plotnine_auroc_by_month(model).save(f"{run_path}/auroc_by_month.png")
