...
from psycop.projects.forced_admission_inpatient.model_evaluation.figures.feature_importance.shap.shap_table import (
...
def shap_dependency_pipeline(
    ...
    if model == "baseline":
        f_path, t_path = FIGURES_PATH, TABLES_PATH
    else:
