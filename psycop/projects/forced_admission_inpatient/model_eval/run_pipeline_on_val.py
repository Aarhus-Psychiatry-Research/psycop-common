...
def _get_test_group_path(pipeline_to_train: ForcedAdmissionInpatientPipelineRun) -> Path:
    return Path(
...
def _get_test_pipeline_dir(pipeline_to_train: ForcedAdmissionInpatientPipelineRun) -> Path:
