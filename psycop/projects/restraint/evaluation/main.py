...
from psycop.projects.restraint.evaluation.figures.auroc_by_region import (
...
from psycop.projects.restraint.evaluation.figures.sensitivity_by_outcome import (
    ...
    sensitivity_by_first_outcome_model,
    sensitivity_by_outcome_model,
)
from psycop.projects.restraint.evaluation.tables.restraint_predictor_describer import (
