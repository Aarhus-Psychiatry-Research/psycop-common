...
from timeseriesflattener.v1.feature_specs.single_specs import PredictorSpec, StaticSpec, OutcomeSpec
...
class TextFeatureSpecifier(FeatureSpecifier):
    ...
    def get_text_feature_specs(self, note_types: list[str], model_names: list[str]) -> list[Union[StaticSpec, PredictorSpec, OutcomeSpec]]:
