...
from psycop.projects.forced_admission_outpatient.model_evaluation.auroc_by.auroc_by_view import (
    auroc_by_view,
)
from psycop.projects.forced_admission_outpatient.model_evaluation.auroc_by.month_of_year_model import (
