...
from psycop.projects.forced_admission_outpatient.old_project_code.model_eval.model_description.performance.plotnine_confusion_matrix import (
...
def fa_outpatient_confusion_matrix_plot(run: ForcedAdmissionOutpatientPipelineRun) -> pn.ggplot:
    ...
    p.save(run.paper_outputs.paths.figures / "fa_outpatient_confusion_matrix.png")

    return p


if __name__ == "__main__":
    fa_outpatient_confusion_matrix_plot(run=get_best_eval_pipeline())
