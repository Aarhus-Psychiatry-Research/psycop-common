from psycop.projects.forced_admission_outpatient.old_project_code.model_eval.model_description.robustness.robustness_by_age import (
    fa_outpatient_auroc_by_age,
)
from psycop.projects.forced_admission_outpatient.old_project_code.model_eval.model_description.robustness.robustness_by_cyclic_time import (
    fa_outpatient_auroc_by_day_of_week,
    fa_outpatient_auroc_by_month_of_year,
)
from psycop.projects.forced_admission_outpatient.old_project_code.model_eval.model_description.robustness.robustness_by_sex import (
    fa_outpatient_auroc_by_sex,
)
from psycop.projects.forced_admission_outpatient.old_project_code.model_eval.model_description.robustness.robustness_by_time_from_first_visit import (
