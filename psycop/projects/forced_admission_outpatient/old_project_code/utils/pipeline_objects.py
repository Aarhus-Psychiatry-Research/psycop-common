...
class RunGroup:
    ...
    def group_dir(self) -> Path:
        return Path(
            f"E:/shared_resources/forced_admissions_outpatient/models/{self.model_name}/pipeline_eval/{self.group_name}"
        )
...
@dataclass
class ForcedAdmissionOutpatientArtifactNames:
    main_performance_figure: str = "fa_outpatient_main_performance_figure.png"
    main_robustness_figure: str = "fa_outpatient_main_robustness.png"
    performance_by_ppr: str = "fa_outpatient_performance_by_ppr.xlsx"
