...
def eval_random_split_test_set(
    ...
    test_run_path = "E:/shared_resources/" + "/clozapine" + "/eval_runs/" + test_run_experiment_name
    ...
    if test_data_path is None:
        test_data_path = best_run_cfg.retrieve("trainer.training_data.paths")

    best_run_cfg = best_run_cfg.add(
        "logger.*.disk_logger", {"@loggers": "disk_logger", "run_path": test_run_path}
    )
