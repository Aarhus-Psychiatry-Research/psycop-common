...
class RunGroup:
    ...
    def group_dir(self) -> Path:
        return Path(
            f"E:/shared_resources/clozapine/models/{self.model_name}/pipeline_eval/{self.group_name}"
        )
...
@dataclass
class ClozapineArtifactNames:
    main_performance_figure: str = "clozapine_main_performance_figure.png"
    main_robustness_figure: str = "clozapine_main_robustness.png"
    performance_by_ppr: str = "clozapine_performance_by_ppr.xlsx"
