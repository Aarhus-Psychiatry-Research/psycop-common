...
from psycop.projects.clozapine.feature_generation.v1_modules.specify_features import (
    FeatureSpecifier,
)
...
def main(
    ...
    feature_specs = FeatureSpecifier(
        ...
        unique_count_antipsychotics=unique_count_antipsychotics,
    ).get_feature_specs()
    ...
    if generate_in_chunks:
        ...
        flattened_df = create_flattened_dataset_tsflattener_v1(
            feature_specs=feature_specs,  # type: ignore
            prediction_times_df=ClozapineCohortDefiner.get_filtered_prediction_times_bundle().prediction_times.frame.to_pandas(),
...
if __name__ == "__main__":
    ...
    main(
        ...
        unique_count_antipsychotics=True,
        feature_set_name="_clozapine_unique_count_antipsychotics",
