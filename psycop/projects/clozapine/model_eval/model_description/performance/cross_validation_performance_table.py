    ...
    xg_df = pd.DataFrame(
        {
            ...
            "model_name": [
                "clozapine hparam, structured_text, xgboost, no lookbehind filter",
                "clozapine hparam, structured_only, xgboost, no lookbehind filter",
                "clozapine hparam, tfidf_180_days, xgboost, no lookbehind filter",
