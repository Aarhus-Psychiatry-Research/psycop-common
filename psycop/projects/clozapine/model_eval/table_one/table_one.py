...
from psycop.projects.clozapine.model_eval.table_one.table_one_lib import (
...
# %%
pred_times_to_keep = ClozapineCohortDefiner.get_filtered_prediction_times_bundle().prediction_times
