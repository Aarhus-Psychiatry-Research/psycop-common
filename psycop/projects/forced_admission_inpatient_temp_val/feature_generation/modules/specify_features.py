...
from psycop.projects.forced_admission_inpatient_temp_val.feature_generation.modules.loaders.demographics_fa_2025 import (
    sex_female,
)
from psycop.projects.forced_admission_inpatient_temp_val.feature_generation.modules.loaders.load_coercion_fa_2025 import (
    af_legemlig_lidelse,
    baelte,
    beroligende_medicin,
    ect,
...
from psycop.projects.forced_admission_inpatient_temp_val.feature_generation.modules.loaders.load_diagnoses_fa_2025 import (
    cluster_b,
    f0_disorders,
    f1_disorders,
    f2_disorders,
...
from psycop.projects.forced_admission_inpatient_temp_val.feature_generation.modules.loaders.load_lab_results_fa_2025 import (
...
from psycop.projects.forced_admission_inpatient_temp_val.feature_generation.modules.loaders.load_medications_fa_2025 import (
    alcohol_abstinence,
    analgesic,
    antidepressives,
    antipsychotics,
...
from psycop.projects.forced_admission_inpatient_temp_val.feature_generation.modules.loaders.load_structured_sfi_fa_2025 import (
    broeset_violence_checklist,
    hamilton_d17,
    mas_m,
    suicide_risk_assessment,
)
from psycop.projects.forced_admission_inpatient_temp_val.feature_generation.modules.loaders.load_visits_fa_2025 import (
...
class FeatureSpecifier:
    ...
    def _get_outcome_specs(self) -> list[OutcomeSpec]:
        ...
        return OutcomeGroupSpec(
            named_dataframes=[
                NamedDataframe(
                    df=forced_admissions_onset_timestamps_2025(), name="forced_admissions"
                )
            ],
            lookahead_days=[30, 90, 180, 365],
    ...
    def _get_outcome_timestamp_specs(self) -> list[OutcomeSpec]:
        ...
        return OutcomeGroupSpec(
            named_dataframes=[
                NamedDataframe(
                    df=forced_admissions_onset_timestamps_2025(timestamp_as_value_col=True), name=""
                )
            ],
            lookahead_days=[30, 90, 180, 365],
