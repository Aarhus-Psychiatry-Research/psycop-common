...
def load_text_sfis(
    ...
    view = "FOR_SFI_fritekst_resultat_udfoert_i_psykiatrien_aendret_tvangsindlæggelse_sep_2025"
...
def load_text_split(
    text_sfi_names: str | Iterable[str] | None, include_sfi_name: bool = False
) -> pd.DataFrame:
