...
from psycop.projects.forced_admission_inpatient_temp_val.table_one.model import TableOneModel
...
def fa_temp_val_table_one(model: TableOneModel) -> pd.DataFrame:
    ...
    visit_frame = _visit_frame(
        ...
        [
            ...
            RowSpecification(
                ...
                readable_name="Involuntary admission within 6 months",
                categorical=True,
                values_to_display=[1],
