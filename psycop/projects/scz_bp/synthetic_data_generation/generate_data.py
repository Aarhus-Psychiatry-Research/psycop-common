...
if __name__ == "__main__":
    ...
    for lr in [0.0001, 0.0005, 0.001]:
        ...
        logger.log_metric(CalculatedMetric(name=f"lr_{lr}_detection_auc_mean", value=score.mean()))
        for i, val in enumerate(score):
            logger.log_metric(CalculatedMetric(name=f"lr_{lr}_detection_auc_fold_{i}", value=val))
