...
if __name__ == "__main__":
    ...
    first_eligible_outcome = pred_times.join(
        outcome_with_age, how="left", on="dw_ek_borger", suffix="_outcome"
    ).sort("timestamp").groupby("dw_ek_borger").first().filter(pl.col("age_outcome").is_not_null())
