...
from psycop.projects.scz_bp.feature_generation.feature_layers.scz_bp_layer_5 import (
    SczBpLayer5,
)
from psycop.projects.scz_bp.feature_generation.feature_layers.scz_bp_layer_6 import (
    SczBpLayer6,
)
