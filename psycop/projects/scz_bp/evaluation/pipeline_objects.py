...
def df_to_eval_dataset(
    ...
    TODO: set these according to my dataset"""
    return EvalDataset(
        ids=df["ids"],
        y=df["y"],
...
@dataclass
class SczBpArtifactNames:
    main_performance_figure: str = "scz_bp_main_performance_figure.png"
    main_robustness_figure: str = "scz_bp_main_robustness.png"
    performance_by_ppr: str = "scz_bp_performance_by_ppr.xlsx"
...
class PaperOutputSettings:
    def __init__(
        ...
        self.artifact_names = SczBpArtifactNames()
