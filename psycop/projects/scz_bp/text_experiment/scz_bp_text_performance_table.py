...
if __name__ == "__main__":
    df = MlflowClientWrapper().get_all_metrics_for_experiment(experiment_name="sczbp/text_5_year_lookahead")
    ...
    table = (
        ...
        .select("Notes", "tfidf_500", "tfidf_1000", "dfm_encoder_large", "dfm_finetuned", "pse_keywords")
    )
