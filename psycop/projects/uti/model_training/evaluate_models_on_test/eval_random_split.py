...
def eval_random_split_test_set(
    ...
    if test_data_path is None:
        test_data_path = [
            "E:/shared_resources/uti/flattened_datasets/uti_feature_set_antibiotics_outcome_definition/uti_feature_set_antibiotics_outcome_definition.parquet"
        ]
    ...
    test_run_path = "E:/shared_resources/" + "/uti" + "/eval_runs/" + test_run_experiment_name
