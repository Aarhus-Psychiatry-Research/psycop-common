---
title: "kohorte_udtrÃ¦k"
output: html_document
---

Dette script udtrÃ¦kker kohorten til prÃ¦diktion af cancer.

Currently, inkluderer den:
1) Alle patienter med diagnosekoden "C" der:
  2) Har fået diagnosen efter første besøg i psykiatrien
  3) Har fået diagnosen efter 2013

Overvej følgende:
- Bør jeg have en washin-period så der skal gå fx X antal måneder fra første besøg til diagnosen er stillet?
- Lige nu håndterer jeg ikke, at patienter kan have fået stillet flere forskellige cancer-diagnoser - jeg bruger blot den første.

Features til baseline uden tekst:
- Snak med Jakob -- strukturede variable som diagnoser, tvang, tidligere kontatker, medicin
- Lav en liste og send til SÃ¸ren og Andreas
