...
from psycop.projects.LungCancer.cohort_definition.eligible_prediction_times.single_filters import (
    LungCancerMinAgeFilter,
    LungCancerMinDateFilter,
    LungCancerPrevalentFilter,
    LungCancerWashoutMoveFilter,
)
...
class LungCancerCohortDefiner(CohortDefiner):
    @staticmethod
    ...
    def get_outcome_timestamps() -> OutcomeTimestampFrame:
        return OutcomeTimestampFrame(frame=pl.from_pandas(get_first_lung_cancer_diagnosis()))


if __name__ == "__main__":
    bundle = LungCancerCohortDefiner.get_filtered_prediction_times_bundle()
