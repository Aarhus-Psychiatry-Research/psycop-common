...
def physical_visits_psykometri_2025(
...
def physical_visits_loader_psykometri_2025(
...
def physical_visits_to_psychiatry_psykometri_2025(
    n_rows: Union[int, None] = None,
...
def physical_visits_to_somatic_psykometri_2025(
    n_rows: Union[int, None] = None, return_value_as_visit_length_days: Union[bool, None] = False
) -> pd.DataFrame:
...
def admissions_psykometri_2025(
    n_rows: Union[int, None] = None,
    return_value_as_visit_length_days: Union[bool, None] = False,
    shak_code: Union[int, None] = None,
...
def ambulatory_visits_psykometri_2025(
    n_rows: Union[int, None] = None,
    return_value_as_visit_length_days: Union[bool, None] = False,
    shak_code: Union[int, None] = None,
    shak_sql_operator: Union[str, None] = None,
...
def emergency_visits_psykometri_2025(
    n_rows: Union[int, None] = None,
    return_value_as_visit_length_days: Union[bool, None] = False,
    shak_code: Union[int, None] = None,
    shak_sql_operator: Union[str, None] = None,
...
def first_visit_to_psychiatry_2025() -> pl.DataFrame:
    first_visit = (
        pl.from_pandas(
