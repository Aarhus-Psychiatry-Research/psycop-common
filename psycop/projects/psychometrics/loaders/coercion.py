...
def coercion_duration(
    ...
    sql = f"SELECT dw_ek_borger, datotid_start, datotid_slut, VARIGHED_TIMER_AFL, TYPE_TXT, BEGRUNDELSE_TXT FROM [fct].[psykometri_tvang] WHERE datotid_start IS NOT NULL AND TYPE_TXT NOT IN {coercion_discard}"
