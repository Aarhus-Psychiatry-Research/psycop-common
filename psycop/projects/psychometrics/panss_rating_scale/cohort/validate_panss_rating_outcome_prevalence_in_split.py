...
from psycop.projects.psychometrics.loaders.demographics import birthdays
...
if __name__ == "__main__":
    ...
    cohort_df = add_only_patients_with_manic_and_bipolar_diagnosis().to_pandas()
    outcome_df = get_mania_rating_scores()
