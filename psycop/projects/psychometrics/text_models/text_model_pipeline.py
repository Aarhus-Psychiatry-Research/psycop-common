...
def create_model_filename(
    ...
    return f"{model}_psycop_psychometrics_preprocessed_{splits_str}_sfi_type_{sfi_type_str}_ngram_range_{ngram_range_str}_max_df_{max_df_str}_min_df_{min_df}_max_features_{max_features}.pkl"


def text_model_pipeline(
    model: Literal["bow", "tfidf"],
    split_ids_presplit_step: FilterByRandom2025Splits,
    corpus_name: str = "psycop_psychometrics_all_sfis_preprocessed",
