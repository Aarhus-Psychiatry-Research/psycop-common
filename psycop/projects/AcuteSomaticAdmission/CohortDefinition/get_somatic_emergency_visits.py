...
def get_contacts_to_somatic_emergency(write: bool = False,  timestamps_only: bool = False, timestamp_as_value_col: bool = False) -> pd.DataFrame:
 #først hentes LPR2 data
    ...
    cols_to_keep = "datotid_lpr3kontaktstart, datotid_lpr3kontaktslut, dw_ek_borger, pt_type, prioritet, shakkode_lpr3kontaktansvarlig"
