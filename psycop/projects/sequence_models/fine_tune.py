...
def create_loaders(cfg: FinetuningConfig, model: EncoderForClassification):  # noqa
...
if __name__ == "__main__":
    ...
    cfg = FinetuningConfig(
        checkpoint_path=Path("checkpoint.ckpt"),  # TODO: change this
        data=data_cfg,
        encoder=encoder_cfg,
    )
    ...
    train_dataloader, val_dataloader = create_loaders(cfg, model)
